...
return convert_number_to_persian(this.day) + " " + months[this.month - 1]+ " " + convert_number_to_persian(this.year);
}
...
h = fixedToHijri(fixd);
document.getElementById("lunar").innerHTML = h.toString();